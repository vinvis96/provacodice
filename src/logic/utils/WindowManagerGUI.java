...
import logic.boundary.ManageRulesGUI;
...
public class WindowManagerGUI extends Application {
	...
	private Scene InsertTopicPostPage;
	private Scene ManageTopicPostPage;
	...
	public void loadManageRulesPage() {
		VBox ManageRules = ManageRulesGUI.getManageRulesScene();
		ManageRulesPage = new Scene(ManageRules, 500, 500);
		WindowManagerGUI.myStage.setScene(ManageRulesPage);
	}
	...
	public void loadInsertTopicPostPage() {
		VBox InsertTopicPost = InsertTopicPostGUI.getInsertTopicPostScene();
		InsertTopicPostPage = new Scene(InsertTopicPost, 500, 500);
		WindowManagerGUI.myStage.setScene(InsertTopicPostPage);	
		
	}

	public void loadManageTopicPostPage() {
		VBox ManageTopicPost = ManageTopicPostGUI.getManageTopicPostScene();
		ManageTopicPostPage = new Scene(ManageTopicPost, 500, 500);
		WindowManagerGUI.myStage.setScene(ManageTopicPostPage);
